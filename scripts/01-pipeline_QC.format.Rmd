...
Downsampling was performed on the UMI level after alignment. This is a slightly biased selection, but is much more computationally efficient than downsampling and rerunning the full processing pipeline, and all samples were downsampled in the same fashion.
...
Number of unique clonotypes observed at different downsampling rates. This relationship addresses the question: **what target UMIs/cell do we need to capture the full repertoire of the input?** 
